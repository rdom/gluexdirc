...
#include "GlxCherenkovProcess.h"
#include "GlxManager.h"

GlxPhysicsList::GlxPhysicsList() 
 : G4VUserPhysicsList(),
   ...
   fMessenger(0) 
{
  fMessenger = new GlxPhysicsListMessenger(this);
  SetVerboseLevel(0);
  fPhysList =  GlxManager::Instance()->GetPhysList();
}

GlxPhysicsList::~GlxPhysicsList() { delete fMessenger; }


void GlxPhysicsList::ConstructParticle()
{
...
void GlxPhysicsList::ConstructProcess()
{
  AddTransportation();
  ConstructDecay();
  ConstructEM();
...
void GlxPhysicsList::ConstructDecay()
{
  // Add Decay Process
...
void GlxPhysicsList::ConstructEM()
{
  theParticleIterator->reset();
  while( (*theParticleIterator)() ){
    G4ParticleDefinition* particle = theParticleIterator->value();
...
void GlxPhysicsList::ConstructOp() 
{
  fCerenkovProcess           = new G4Cerenkov("Cerenkov");
  fCerenkovProcess0          = new GlxCherenkovProcess("Cerenkov");
  fScintillationProcess      = new G4Scintillation("Scintillation");
  fAbsorptionProcess         = new G4OpAbsorption();
  fRayleighScatteringProcess = new G4OpRayleigh();
  fMieHGScatteringProcess    = new G4OpMieHG();
  fBoundaryProcess           = new GlxOpBoundaryProcess();
...
void GlxPhysicsList::SetVerbose(G4int verbose)
{
