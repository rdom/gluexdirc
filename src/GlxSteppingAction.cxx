...
GlxSteppingAction::GlxSteppingAction() : G4UserSteppingAction(){ 
  fScintillationCounter = 0;
  fCerenkovCounter      = 0;
  fEventNumber = -1;
}

GlxSteppingAction::~GlxSteppingAction(){ }

void GlxSteppingAction::UserSteppingAction(const G4Step* step){
